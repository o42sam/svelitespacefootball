<script lang="ts">
    ...
    import bgPlayers from "$lib/img/other/players-bg.png"
...
<section
class="flex flex-col items-center p-16 pt-0 w-3/5 self-center text-xl">
    <div class="bg-inherit p-9 mt-60">
    ...
    <div class="absolute h-full w-full -z-30 bg-neutral-200 bg-opacity-90"></div>
    <img class="absolute -z-40 h-full w-full" src="{bgPlayers}" alt="" />
</section>
